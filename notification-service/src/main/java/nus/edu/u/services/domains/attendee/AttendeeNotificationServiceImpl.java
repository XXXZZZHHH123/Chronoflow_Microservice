...
public class AttendeeNotificationServiceImpl implements AttendeeNotificationService {
    ...
    private static final String INLINE_CID = "qr-code";
    ...
    private static Map<String, Object> getAttendeeInviteTemplateVars(AttendeeInviteReqDTO req) {
        ...
        vars.put("qrCodeCid", "qr-code");
        vars.put("logoCid", "logo");
    ...
    private static List<AttachmentDTO> getInlineLogoAttachment() {
        ...
        try {
            ...
            if (res.exists()) {
                ...
                log.warn("Classpath image not found at images/logo.png");
            }
        } catch (Exception e) {
            log.warn("Failed to load inline logo from classpath: {}", e.getMessage());
        }
        return attachments;
    }
}