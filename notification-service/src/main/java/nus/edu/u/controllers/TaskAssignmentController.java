...
/**
 * Controller to test and trigger task assignment notifications
 * across multiple channels (push + email).
 */
@RestController
...
public class TaskAssignmentController {
     ...
     *
     * Example:
     * POST /api/v1/task/assign/notify
     * {
     *   "taskId": "42",
     *   "assigneeUserId": "1976859664874131458",
     *   "assigneeEmail": "john.doe@example.com",
     *   "assignerName": "Alice Tan",
     *   "taskName": "Prepare Event Slides",
     *   "eventName": "ChronoFlow Kickoff"
     * }
     */
