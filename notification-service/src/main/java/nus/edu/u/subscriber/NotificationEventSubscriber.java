    ...
    public void startSubscriber() {
        ...
        pubSubTemplate.subscribe(SUBSCRIPTION, message -> {
            ...
            try {
                ...
                // Parse JSON into DTO
                NotificationRequestDTO req = objectMapper.readValue(data, NotificationRequestDTO.class);

                // Validate required fields
                if (req.getChannel() == null || req.getEventId() == null || req.getType() == null) {
                ...
                log.info("[PUBSUB] Processed notification. eventId={} channel={} result={}",
                        req.getEventId(), req.getChannel(), result);
