...
/**
 * Test controller that exposes two ways to send:
 * 1) JSON body (attachments as base64)  -> /send/json
...
//    }
    ...
    public ResponseEntity<Map<String, String>> sendAttendeeInvite(
            @RequestBody AttendeeInviteReqDTOTest reqTest
    ) throws Exception {
        ...
        var req = AttendeeInviteReqDTO.builder()
        ...
        HttpStatus http = "ALREADY_ACCEPTED".equals(status)
                ? HttpStatus.OK
                : HttpStatus.ACCEPTED;
