...
public class TaskNotificationMapper {
    ...
    /** EMAIL */
    public static NotificationRequestDTO taskAssignmentToEmailNotification(NewTaskAssignmentDTO req) {
    ...
    /** PUSH */
    public static NotificationRequestDTO taskAssignmentToPushNotification(NewTaskAssignmentDTO req) {
        Map<String, Object> vars = Map.of(
                "taskId",         req.getTaskId(),
                "eventId",        req.getEventId(),
                "assigneeUserId", req.getAssigneeUserId(),
    ...
    public static NotificationRequestDTO taskAssignmentToWsNotification(NewTaskAssignmentDTO req) {
        Map<String, Object> vars = Map.of(
                ...
                "eventName",      req.getEventName(),
                "description",    req.getDescription(),
                "deepLink",       String.format("/events/%s/tasks/%s", req.getEventId(), req.getTaskId())
        );
